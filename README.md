...
<br><br>
If you want to rebuild the text generation pipeline, follow the instructions in the 
[install_instructions.](https://github.com/realtechsupport/nudge-x/blob/main/install_instructions.txt).
<br>
If you want to recreate the UI, follow the instructions in the
[app deployment.](https://github.com/realtechsupport/nudge-x/blob/main/frontend/notes/earth_deployment_instructions.md)
