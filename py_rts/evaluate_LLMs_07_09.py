...
class CaptionEvaluator:
    ...
    def _calculate_decision(self, evaluation_result: dict, weights: dict = None, threshold: float = 3.5) -> int:
        ...
        if weights is None:
            weights = {
                "Environmental_Impact": 1/6,
                "Accuracy_Plausibility": 1/6,
                "Specificity_Terminology": 1/6,
                "Processes_Patterns": 1/6,
        ...
        weighted_score = (
            evaluation_result.get("Environmental_Impact", 0) * weights.get("Environmental_Impact", 0) +
            evaluation_result.get("Accuracy_Plausibility", 0) * weights.get("Accuracy_Plausibility", 0) +
            evaluation_result.get("Specificity_Terminology", 0) * weights.get("Specificity_Terminology", 0) +
            evaluation_result.get("Processes_Patterns", 0) * weights.get("Processes_Patterns", 0) +
