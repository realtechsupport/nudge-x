...
The general goal is to provide accurate descriptions of land cover conditions, including vegetation coverage, built-up areas with industrial and urban development.
...
"""
    ...
    def _parse_llm_response(self, json_string: str) -> dict:
        ...
        # Validate keys and cast to float
        try:
            return {
