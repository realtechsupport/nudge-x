...
def LlamaCaptionGenerator(
    ...
    image_b64 = compress_image(image_file_path, quality)
    second_image_b64 = None
    third_image_b64 = None
    
    if second_image_file_path_or_image is not None:
        second_image_b64 = compress_image(second_image_file_path_or_image, quality)
    
    if third_image_file_path_or_image is not None:
        third_image_b64 = compress_image(third_image_file_path_or_image, quality)
